...
router.post("/add_manufacture",upload.array('image',10),ManufacturerController.create);
...
router.put("/update_manufacturer_by_id",upload.array('image'),ManufacturerController.find_and_update)
