...
router.post("/add_blog",upload.array('featuredImage',10),blogController.create);
router.post("/find_blog_by_slug",blogController.find_by_slug)
router.get("/find_all_slug",blogController.find_all)
router.put("/update_slug_by_id",upload.array('featuredImage',10),blogController.find_and_update)
